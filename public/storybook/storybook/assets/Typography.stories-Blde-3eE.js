import{j as a}from"./jsx-runtime-CGdb-zRh.js";import"./iframe-B4fJKyuY.js";import"./preload-helper-PPVm8Dsz.js";const i={h1:"text-[48px] font-black leading-[1.1]",h2:"text-[36px] font-bold leading-[1.2]",h3:"text-[28px] font-bold leading-[1.3]","body-lg":"text-[20px] font-regular leading-[1.6]","body-md":"text-[18px] font-regular leading-[1.6]","body-sm":"text-[16px] font-light leading-[1.6]",caption:"text-[14px] font-light leading-[1.4]"};function e({variant:n,children:r,className:o=""}){return a.jsx("div",{className:`font-migdal ${i[n]} ${o}`,children:r})}e.__docgenInfo={description:"",methods:[],displayName:"Typography",props:{variant:{required:!0,tsType:{name:"union",raw:`| "h1"
| "h2"
| "h3"
| "body-lg"
| "body-md"
