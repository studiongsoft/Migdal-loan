import{j as t}from"./jsx-runtime-DMt_yit2.js";import{r as l}from"./iframe-Ci18ShzC.js";import{C as o}from"./Checkbox-ghvtSkW-.js";import"./preload-helper-PPVm8Dsz.js";const h={title:"Design System/Checkbox",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{checked:{control:"boolean"},disabled:{control:"boolean"},size:{control:{type:"number",min:16,max:32}}}},e={args:{checked:!1}},r={args:{checked:!0}},s={render:()=>{const[n,d]=l.useState(!1);return t.jsxs("label",{className:"flex cursor-pointer items-center gap-3",dir:"rtl",children:[t.jsx(o,{checked:n,onChange:d}),t.jsx("span",{className:"text-[18px] font-light text-[var(--color-primary)]",children:"חשבון זהה גם להעברת כספי ההלוואה וגם לגביית ההחזרים החודשיים"})]})}},a={args:{checked:!1,disabled:!0}},c={args:{checked:!0,disabled:!0}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    checked: false
  }
